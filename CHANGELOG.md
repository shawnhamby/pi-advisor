...
- After settle, if bound work remains, no messages are queued, and no tools are live, emit one follow-up continuation per trusted-input epoch instead of leaving the agent idle.
